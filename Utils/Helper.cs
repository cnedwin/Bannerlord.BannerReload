...
namespace BannerReload
{
	public static class Helper
	{
		...
		public static string SavePath
		{
			get
			{
				return Environment.GetFolderPath(Environment.SpecialFolder.Personal) + "\\Mount and Blade II Bannerlord\\BannerReload\\";
			}
		}
		...
		public static string LogPath
		{
			get
			{
				return Helper.SavePath + "BannerReload_log.txt";
			}
		}
